...
- For novelty disputes, start by acknowledging the relevant overlap or prior work, then gently clarify if the reviewer's framing is broader than the paper's actual claim, and only then state the paper's actual contribution. Do not sound corrective or combative while doing this.
